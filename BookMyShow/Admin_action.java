...
public class Admin_action {
    ...
    public static User login(String adminId) {
    ...
    public static void adminOps() {
        ...
        while (run) {
            ...
            switch (choice) {
                case 1:
                    addAdmin(); // Call method to add a new admin
                    break;
                case 2:
                ...
                case 7:
                    ...
                    run = false; // Set flag to false to exit the loop
                    break;
                default:
    ...
    public static Show anothershow(LocalDate date, Scanner sc, Screen screen, int price, int duration) {
    ...
    public static boolean overlapshow(LocalTime startTime, LocalTime endTime, Screen screen, LocalDate date) {

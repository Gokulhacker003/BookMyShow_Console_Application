...
class Customer_action {
    ...
    public static User login(String id) {
        ...
        for (User user : BookMyShow_POJO.getUserList()) { // Iterating through the list of users
            if (user instanceof Customer) { // Check if the current user is a Customer
                    if (user.getId().equals(id)) { // Match input ID with the stored user ID
    ...
    public static void CustomerOps(Customer customer) {
        Scanner scanner = new Scanner(System.in);
    ...
    public static void movie_select(Customer customer) {
        Scanner scanner = new Scanner(System.in);
    ...
    public static boolean movie_in_My_location(Customer customer) {
        Scanner scanner = new Scanner(System.in);
    ...
    public static void movie_in_theatres( ArrayList<Movie> movies,HashMap<String, HashSet<Show>> shows_list, Customer customer) {
        boolean check = false;
    ...
    public static void changeLocationDate(Customer customer) {
        Scanner scanner = new Scanner(System.in);
    ...
    public static void BookTicket(ArrayList<Movie> movies,Customer customer){
    ...
    public static ArrayList<String> select_seats(int counts, Show show) {
        Scanner scanner = new Scanner(System.in);
    ...
    public static int calculateSeatIndex(int seat, String[] grid, int totalSeats) {

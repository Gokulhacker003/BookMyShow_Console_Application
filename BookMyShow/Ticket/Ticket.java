package Ticket; // Declare package for Ticket class

import java.time.LocalTime; // Import LocalTime for handling time
import java.util.ArrayList; // Import ArrayList for storing booked tickets
